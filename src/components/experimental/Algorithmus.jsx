...
class Parkplatz {
  ...
  getUsers() {
    ...
    this.users.forEach(userArr => {
      Array.isArray(userArr) ? userArr.forEach(user => uArr.push(user)) : uArr.push(userArr);
    });
...
class Experimental extends Component {
  ...
  algo2 = tag => {
    ...
    //Schiebe alle Parkplätze in ein Array
    var AlleParkplaetze = [HP, NP];
    //Gib dieses Array zurück
    console.log(AlleParkplaetze);
